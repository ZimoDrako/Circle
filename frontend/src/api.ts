...
export const api = {
  ...
  getCircleFeedback: (id: string) => req(`/circles/${id}/feedback`),
  saveCircleFeedback: (id: string, outcome: "great" | "okay" | "not_for_me") =>
    req(`/circles/${id}/feedback`, { method: "POST", body: JSON.stringify({ outcome }) }),
