...
const useStyles = makeStyles((colors) => ({
  ...
  profileTabs: { flexDirection: "row", marginTop: spacing.lg, borderBottomWidth: 1, borderBottomColor: colors.divider }, profileTab: { flex: 1, alignItems: "center", paddingVertical: 12, position: "relative" }, profileTabText: { color: colors.muted, fontSize: 13, fontWeight: "800" }, profileTabTextActive: { color: colors.onSurface }, profileTabLine: { position: "absolute", left: "24%", right: "24%", bottom: -1, height: 2, borderRadius: 2, backgroundColor: themeColors.brandPrimary },
  ...
  compactCard: { marginHorizontal: spacing.xl, marginTop: spacing.lg, flexDirection: "row", alignItems: "center", gap: spacing.sm, padding: spacing.lg, borderRadius: radius.lg, backgroundColor: colors.surfaceSecondary }, compactTitle: { color: colors.onSurface, fontWeight: "800" }, compactValue: { color: colors.muted, fontSize: 12, flex: 1, textAlign: "right" }, pending: { marginHorizontal: spacing.xl, marginTop: spacing.lg, flexDirection: "row", gap: spacing.sm, padding: spacing.md, borderRadius: radius.md, backgroundColor: themeColors.brandTertiary }, pendingText: { color: colors.onBrandTertiary, fontWeight: "700", flex: 1 },
