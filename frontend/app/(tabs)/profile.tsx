...
const useStyles = makeStyles((colors) => ({
  ...
  lookingWrap: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: spacing.md }, lookingTag: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: radius.pill }, lookingTag0: { backgroundColor: "#203A5F" }, lookingTag1: { backgroundColor: "#3A285F" }, lookingTag2: { backgroundColor: "#5A3A18" }, lookingTag3: { backgroundColor: "#173F32" }, lookingTag4: { backgroundColor: "#5A2635" }, lookingText: { color: "#FFFFFF", fontSize: 12, fontWeight: "700" },
