...
const styles = StyleSheet.create({
  ...
  interestGrid: { flexDirection: "row", flexWrap: "wrap", gap: 10, marginTop: spacing.md }, interestTile: { width: "30%", minWidth: 86, alignItems: "center", gap: 7, paddingVertical: 10 }, interestEmblem: { width: 48, height: 48, borderRadius: 24, backgroundColor: colors.brandTertiary, alignItems: "center", justifyContent: "center" }, interestName: { color: colors.onSurface, fontSize: 11, fontWeight: "700", maxWidth: 88, textAlign: "center" }, more: { minWidth: 42, height: 34, paddingHorizontal: 10, borderRadius: 17, borderWidth: 1, borderColor: colors.borderStrong, alignItems: "center", justifyContent: "center" }, moreText: { color: colors.onSurface, fontWeight: "800", fontSize: 12 },
