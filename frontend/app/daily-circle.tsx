  ...
  return (
    <SafeAreaView style={styles.root} edges={["top"]}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Pressable style={styles.cta} onPress={() => router.replace("/(tabs)/discover")}>
          <Text style={styles.ctaText}>Find my Circle</Text><Icon name="arrow-forward" size={18} color={colors.onBrandPrimary} />
        </Pressable>
        <Text style={styles.demoNote}>Matching preview — live Daily Circle formation is coming next.</Text>
      </ScrollView>
      <MainTabBar />
    </SafeAreaView>
  );
